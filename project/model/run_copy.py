...
for prm1 in [0]:
    for prm2 in [256]:
        net = model.Variable(num_layer=16, num_filters=256, flag=False).to(device)
        ...
        print(f'num_layer=16, num_filters=256, filter変化の足りないやつ')
        ...
        plt.savefig(f'copyfixed_{val_loss_list[-1]:.2f}_{prm1}_{prm2}.png')
